...
# Matches with 'mc: "Yadi yada: That's it."' where 'mc:' is matched.
# ':' can be stripped off later.
char_re = r"^\w+:" # Used to extract the character thinking/talking from the text.
